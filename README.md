...
Zie [script](script/) voor de uitwerking van de methode, gebruik verder deze [count matrix](data/count_matrix_RA%20(1).txt).


<p align="center">
  <img width="4032" height="1975" alt="Mermaid-preview" src="https://github.com/user-attachments/assets/5ff8392e-e30c-4747-b180-29a41f6f7a3b" />
  <em>
    <strong>Figuur 1. Overzicht van de transcriptomics analyseworkflow voor RA versus controle.</strong><br>
Het figuur toont de opeenvolgende stappen van de RNA‑seq analyse. Links wordt de mapping van RNA‑seq reads naar het humane referentiegenoom (GRCh38) weergegeven, waarbij FASTQ-bestanden worden omgezet naar BAM-bestanden. In het middelste deel wordt met behulp van een GTF-annotatiebestand een count matrix opgesteld, waarin het aantal reads per gen wordt bepaald. In het rechterdeel wordt de statistische analyse uitgevoerd, gevolgd door verschillende vormen van downstream analyse en visualisatie, waaronder differentiële genexpressieanalyse, volcano plot, KEGG pathway-analyse en Gene Ontology (GO)-analyse. De workflow is gebaseerd op analyse van 4 RA- en 4 controlemonsters en is uitgevoerd met behulp van Bioconductor-tools.
  </em>
</p>
...
<p align="center">
  ...
  <em>
    <strong>Figuur 2. Volcano plot van differentiële genexpressie tussen RA en controle.</strong><br>
...
De KEGG pathway-analyse liet zien dat meerdere biologische routes betrokken zijn bij RA. In de cytokine-cytokine receptor interactie pathway (Figuur 3) werden verschillende genen met veranderde expressie waargenomen, het zelfde in de hematopoietische cel lineage (Figuur 4) en de celcyclus pathway (Figuur 5). Deze pathways bevatten genen die betrokken zijn bij immuunsignalering en celprocessen.
...
<p align="center">
  ...
  <em>
    <strong>Figuur 3. KEGG pathway ‘cytokine-cytokine receptor interaction’ (hsa04060) voor RA versus controle.</strong><br>
...
<p align="center">
  ...
  <em>
    <strong>Figuur 4. KEGG pathway ‘hematopoietic cell lineage’ (hsa04640) voor RA versus controle.</strong><br>
Het figuur toont genexpressie binnen de differentiatie van immuuncellen gebaseerd op RNA-seq data. Elk vakje vertegenwoordigt een gen en is ingekleurd op basis van de log₂ fold change. Rood geeft genen met hogere expressie in RA weer en groen genen met lagere expressie in RA. De schaal van de expressieverandering wordt weergegeven in de kleurenbalk rechtsboven (−1 tot +1). Witte vakjes geven genen weer waarvoor geen significant verschil of geen data beschikbaar is. De figuur is gegenereerd met pathview op basis van KEGG pathway annotatie. De data zijn afkomstig van synoviumweefsel van 4 RA-patiënten en 4 controles.
 ...
 <img width="1105" height="877" alt="hsa04110 pathview GOED" src="https://github.com/user-attachments/assets/4dfbdbf9-0bda-4c43-9525-8d543c5199f4" />
  <em>
    <strong>Figuur 5. KEGG pathway ‘cell cycle’ (hsa04110) voor RA versus controle.</strong><br>
...
<p align="center">
  ...
  <em>
    <strong>Figuur 6. Top significante GO-termen bij RA ten opzichte van controle.</strong><br>
